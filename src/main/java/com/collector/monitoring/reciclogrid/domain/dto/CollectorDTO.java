...
public record CollectorDTO(Long id, String name, String category, Address address, Integer distance, BigDecimal percentage, boolean active) {
    public static CollectorDTO buildCollectorDTO(Collector collector) {
        ...
        return new CollectorDTO(collector.getId(), collector.getName(), collector.getCategory(), collector.getAddress(), distance, percentage, collector.isActive());
    }
}
