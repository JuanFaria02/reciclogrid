...
public record CollectorDTO(String name, String category, Address address, Integer distance, BigDecimal percentage) {
    public static CollectorDTO buildCollectorDTO(Sensor sensor, Collector collector) {
        ...
        return new CollectorDTO(collector.getName(), collector.getCategory(), collector.getAddress(), distance, percentage);
    }
}
